...
public class NMSBridgeImpl implements NMSBridge {
    ...
    /**
     * Serves as the fallback for any future 1.21.x versions that retain Mojang-mapped
     * CraftBukkit class names (no version prefix). When no exact bridge exists for a
     * newer version, this implementation is used automatically.
     */
    @Override
